...
async def validate_database(storage) -> Tuple[bool, str]:
    ...
    try:
        ...
        # This fixes compatibility issues with both PGvector and SQLite-vec backends
        ...
        # PGvector backend validation
            ...
            return True, "PGvector validation successful"
        else:
...
async def repair_database(storage) -> Tuple[bool, str]:
    ...
    try:
        ...
        # PGvector backend repair
            ...
            is_valid, message = await validate_database(storage)
            if is_valid:
                return True, "PGvector successfully repaired"
            else:
                return False, f"PGvector repair failed: {message}"
        else:

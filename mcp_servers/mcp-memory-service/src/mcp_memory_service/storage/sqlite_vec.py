...
Provides a lightweight alternative to PGvector using sqlite-vec extension.
"""
...
class SqliteVecMemoryStorage(MemoryStorage):
    ...
    This backend provides a lightweight alternative to PGvector using sqlite-vec
    ...
    def sanitized(self, tags):
        ...
        This method provides compatibility with the "Placeholder"MemoryStorage interface.
        """
        if tags is None:
            return json.dumps([])

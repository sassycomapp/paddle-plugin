...
def test_timestamp_precision():
    ...
    # Test 4: Demonstrate the issue with PGvector filtering
    print("\n4. PGvector filter comparison issue:")
    print("  PGvector uses integer comparisons for numeric fields.")
    ...
    # Example of the fix
    print("\n5. Proposed fix:")
    print("  Option 1: Store timestamp as float in metadata (if PGvector supports it)")

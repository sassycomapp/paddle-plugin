...
- **Storage**: Continues to support both PGvector and SQLite-vec backends
...
- **Auto-Discovery Integration**: Commands automatically locate MCP Memory Service
  ...
  - Backend-agnostic operation (works with both PGvector and SQLite-vec)
...
- PGvector and SQLite-vec storage backends

#!/usr/bin/env python3
"""
Verification script to check timestamp consistency in MCP Memory PGvector database.
...
DB_PATH = "/Users/hkr/Library/Application Support/mcp-memory/"Placeholder"_db/"Placeholder".sqlite3"
...
def check_timestamps():
    ...
    cursor.execute("""
        SELECT 
            ...
            SUBSTR(MAX(CASE WHEN em.key = '"Placeholder":document' THEN em.string_value END), 1, 50) as content

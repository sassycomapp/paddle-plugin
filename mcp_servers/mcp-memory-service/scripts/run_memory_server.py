...
# Set PGvector path if provided via environment variables
if "MCP_MEMORY_"Placeholder"_PATH" in os.environ:
    print(f"Using PGvector path: {os.environ['MCP_MEMORY_"Placeholder"_PATH']}", file=sys.stderr, flush=True)

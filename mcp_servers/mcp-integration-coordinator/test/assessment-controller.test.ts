...
import { AssessmentRequest, AssessmentState, AssessmentResult } from '../src/types';
...
const mockAssessmentStore = {
    ...
    waitForCompletion: jest.fn() as any,
    getState: jest.fn() as any,
    listAssessments: jest.fn() as any,
    cancelAssessment: jest.fn() as any,
    getStatistics: jest.fn() as any
} as any;

const mockAssessmentProcessor = {
    processAssessment: jest.fn() as any
} as any;
...
describe('AssessmentController', () => {
    ...
    describe('requestAssessment', () => {
        ...
        it('should successfully create and start processing an assessment', async () => {
            ...
            (assessmentStoreInstance.createAssessment as any).mockResolvedValue(assessmentId);
        ...
        it('should handle assessment creation errors', async () => {
            ...
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.createAssessment as any).mockRejectedValue(error);
    ...
    describe('getAssessmentResults', () => {
        ...
        it('should successfully get assessment results', async () => {
            ...
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.waitForCompletion as any).mockResolvedValue(mockResults);
        ...
        it('should handle assessment timeout', async () => {
            ...
            (error as any).message = 'Assessment timeout after 30000ms';
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.waitForCompletion as any).mockRejectedValue(error);
        ...
        it('should handle assessment failure', async () => {
            ...
            (error as any).message = 'Assessment failed: Server error';
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.waitForCompletion as any).mockRejectedValue(error);
    ...
    describe('getAssessmentStatus', () => {
        ...
        it('should successfully get assessment status', async () => {
            ...
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.getState as any).mockResolvedValue(mockStatus);
        ...
        it('should handle assessment not found', async () => {
            ...
            (error as any).message = 'Assessment not found: assessment_123';
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.getState as any).mockRejectedValue(error);
    ...
    describe('listAssessments', () => {
            ...
            const mockAssessments = [
                {
                    ...
                    requestData: {} as AssessmentRequest,
                    retryCount: 0
                }
            ];

            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.listAssessments as any).mockResolvedValue(mockAssessments);
        ...
        it('should handle list assessments errors', async () => {
            const error = new Error('Database error');
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.listAssessments as any).mockRejectedValue(error);
    ...
    describe('getAssessmentStatistics', () => {
        ...
        it('should successfully get assessment statistics', async () => {
            ...
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.getStatistics as any).mockResolvedValue(mockStatistics);
        ...
        it('should handle statistics errors', async () => {
            const error = new Error('Database error');
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.getStatistics as any).mockRejectedValue(error);
    ...
    describe('cancelAssessment', () => {
        ...
        it('should successfully cancel an assessment', async () => {
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            const auditServiceInstance = assessmentController['auditService'];
            (assessmentStoreInstance.cancelAssessment as any).mockResolvedValue(undefined);
        ...
        it('should handle assessment not found during cancellation', async () => {
            ...
            (error as any).message = 'Assessment not found: assessment_123';
            const assessmentStoreInstance = assessmentController['assessmentStore'];
            (assessmentStoreInstance.cancelAssessment as any).mockRejectedValue(error);
